...
export default function Navbar() {
    ...
    const handleLogout = async () => {
        try {
            const response = await fetch("https://bhilaieats-web.onrender.com/b.onrender.com/b.onrender.com/b.onrender.com//api/auth/logout", {
                method: "POST",
                headers: {
                            ...
                            <ul className="navbar-nav">
                                <div className="d-flex align-items-center ml-auto">
                                    <li className="nav-item cart-icon mx-3">
                                        <Link to="/">
                                            <button className="btn btn-success"> Admin Page </button>
                                        </Link>
                                    </li>
